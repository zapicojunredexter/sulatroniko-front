        ...
        >
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              <div class="md-form">
                  <input accept="image/jpg, image/jpg, image/png," style={{borderColor: 'transparent', marginBottom: 50}} onChange={(event) => this.setState({cover: event.target.files})} type="file" id="field" class="form-control" accept="image/jpg, image/jpg, image/png," />
              ...
              <div class="text-center">
                <button
                    ...
                    type="button"
                    class="btn btn-cyan"
                    disabled={!this.state.synopsis || !this.state.cover}
                >
                    Publish Book
                </button>
              </div>
